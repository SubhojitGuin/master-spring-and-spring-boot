...
@ControllerAdvice // Makes it available to all the controllers
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(Exception.class) // Exception.class in ExceptionHandler means all exceptions will be handled
    ...
    @ExceptionHandler(UserNotFoundException.class) // Exception.class in ExceptionHandler means all exceptions will be handled
    ...
    @ExceptionHandler(PostNotFoundException.class) // Exception.class in ExceptionHandler means all exceptions will be handled
    ...
    protected @Nullable ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(),
                "Total Error Count: " + ex.getErrorCount() + " First Error: " + ex.getFieldError().getDefaultMessage(), request.getDescription(false));
